...
export default function QuotesPage() {
  ...
  const convertMutation = useMutation({
    ...
    onSuccess: (res) => {
      ...
      router.push(`/businesses/${businessId}/invoices`);
    },
  });
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1 text-xs text-gray-400 dark:text-gray-500">
                        ...
                        {quote.invoice && (
                          <Link href={`/businesses/${businessId}/invoices`} className="text-purple-600 dark:text-purple-400 hover:underline flex items-center gap-1">
